\chapter{Popular Tools and Their Limitations}\label{ch:2}
...
GHArchive mines the GitHub event stream through the use of webhooks.
...
Furthermore, it suffers from an issue which inhibits its accessibility.
