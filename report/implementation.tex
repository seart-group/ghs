...
In order to design the relational schema for the database, we have to answer the following question: \emph{Which information is relevant to select software repositories for MSR studies?}
...
%TODO Comments on auxiliary data like branch name (useful for accessing files in the repository/studies that focus on the main branch: ), last commit SHA (data up to that commit, useful for the users of the dataset), homepage (just generally useful), license (projects with specifict types of liceses: https://dl.acm.org/doi/10.1145/3180155.3180221)...
