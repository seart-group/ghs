...
\begin{itemize}
    ...
    \item An application container, which based on a \textit{maven-chrome}\footnote{\url{https://hub.docker.com/r/markhobson/maven-chrome}} image hosts the application back-end;
