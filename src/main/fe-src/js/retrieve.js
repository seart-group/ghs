...
function appendResult(item) {
    ...
    let repo_commits = item.commits ?? "N/A";
    let repo_branches = item.branches ?? "N/A";
    let repo_defaultBranch = item.defaultBranch;
    let repo_releases = item.releases ?? "N/A";
    let repo_contributors = item.contributors ?? "N/A";
    let repo_license = item.license;
    let repo_watchers = item.watchers ?? "N/A";
    let repo_stargazers = item.stargazers ?? "N/A";
    let repo_forks = item.forks ?? "N/A";
    ...
    let repo_totalIssues = item.totalIssues ?? "N/A";
    let repo_openIssues = item.openIssues ?? "N/A";
    let repo_totalPullRequests = item.totalPullRequests ?? "N/A";
    let repo_openPullRequests = item.openPullRequests ?? "N/A";
    let repo_lastCommit = (item.lastCommit !== null) ? item.lastCommit.replace("T"," ") : "N/A";
