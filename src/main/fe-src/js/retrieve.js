...
function retrieve(url) {
    fetch(url).then(response => {
        ...
        if (totalItems > 0){
            let count = '<div><div class="row mw-100 pt-3 mx-3"><div class="col d-flex align-items-center justify-content-start px-0"><span class="text-secondary">Results: '+totalItems+'</span></div><div class="col d-flex align-items-center justify-content-end px-0"><span class="text-secondary">Page: '+page+'</span></div></div></div>';
