...
public class GitRepoConverter {
    ...
    public String[] repoDtoToCSVRow(GitRepoDto repoDto){
        ...
        attributes[2]  = (commits==null)?"?":( (commits.equals(RepoHtmlPageExtraInfo.INFINITE))?"∞":commits.toString());
        ...
        attributes[6]  = contributors==null?"?":( (contributors.equals(RepoHtmlPageExtraInfo.INFINITE))?"∞":contributors.toString());
