...
//  static String commitsReg          = "#js-repo-pjax-container > div > div > div > div > div > div > div > div:nth-child(4) > ul > li > a > span > strong";
    static String commitsReg          = ".js-details-container > div > ul > li > a > span > strong";
    static String commitsRegAlt   = "#repo-content-pjax-container > div > div > div > div > div > div > div > ul > li > a > span > strong";
...
//  static String branchesReg         = "#js-repo-pjax-container > div > div > div > div > div > div > a:nth-child(1) > strong";
    static String branchesReg         = "#js-repo-pjax-container > div > div > div > div > div > div > div > a > strong";
    ...
    static String releasesReg         = "#js-repo-pjax-container > div > div > div > div > div > div > div > a:nth-child(2) > strong";
    static String releasesRegAlt         = "#js-repo-pjax-container > div > div > div > div > div > div > a:nth-child(2) > strong";
    ...
    static String contributorsVerify  = "#repo-content-pjax-container > div > div > div:nth-child(2) > div > div:nth-child(5) > div > h2 > a";
    static String contributors        = "#repo-content-pjax-container > div > div > div:nth-child(2) > div > div:nth-child(5) > div > h2 > a > span";
