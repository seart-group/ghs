...
We host said dump on [Dropbox](https://www.dropbox.com/s/exda7v3xjy6bafp/gse.sql.gz?dl=1), and after downloading, you can import the data by running:
