...
We host said dump on [Dropbox](https://www.dropbox.com/scl/fi/l4lzv5k5lvm3t0kay9w71/gse.sql.gz?rlkey=x4i9ms266dhmh4yo7jkevedoe&dl=1), and after downloading, you can import the data by running:
...
| `app.crawl.analysis.scheduling`       | Integer            | 21600000 (6h, in ms)                                                    | Analysis job scheduling rate, expressed as a numeric string                                                                                                           |
...
| `gse-server`           |                 [gse/backend](docker/Dockerfile.be)                  | for the spring application itself |      :white_check_mark:       | `gse-migration` |
| `gse-website`          |                 [gse/frontend](docker/Dockerfile.fe)                 | for supplying the front-end files |      :white_check_mark:       |  `gse-server`   |
