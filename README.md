# GitHub Search &middot; [![Status](https://badgen.net/https/dabico.npkn.net/ghs-status)](http://seart-ghs.si.usi.ch) [![MIT license](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/seart-group/ghs/blob/master/LICENSE) [![Latest Dump](https://img.shields.io/badge/Latest_Dump-01.07.24-blue)](https://www.dropbox.com/scl/fi/ukb7jwhbfljp4e8lteqyr/gse.sql.gz?rlkey=q8p5tsj93vz27nmxcelb6ccl2&st=0niplq73&dl=1) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.4588464.svg)](https://doi.org/10.5281/zenodo.4588464) <!-- markdownlint-disable-line -->
...
| `ghs.cloc.analysis-timeout-duration` | Duration                 | 5m                                                                      | Maximum time allowed for a `cloc` command to execute.                                                                                                                                                                                                              |
